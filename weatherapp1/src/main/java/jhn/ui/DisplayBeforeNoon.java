...
public class DisplayBeforeNoon implements MouseListener{
    Weather weather;
    JPanel background;
    ...
    public DisplayBeforeNoon(JFrame parentFrame, Weather weather, LocalDate date,JPanel timeDividerPanel) {
